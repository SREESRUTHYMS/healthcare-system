...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // TODO: replace with POST /api/auth/login against your Express API
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-6 py-16">
      <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-pulse">Welcome back</p>
      <h1 className="mt-3 font-display text-3xl font-semibold text-ink">Log in to Vitals</h1>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        ...
        <div>
          <label className="font-body text-sm font-medium text-ink/80">I am a</label>
